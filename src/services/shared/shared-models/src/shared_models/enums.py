...
class Paths ( BaseModel ):
    ...
    NEURAL_CODE_GENERATOR_PATH: str = Field(
        "build_with_ai/app/neural_code_generator", description="Path for neural code generator"
    )
    KNOWLEDGE_BASE_PATH: str = Field("build_with_ai/app/knowledge_base", description="Path for knowledge base")
    AST_CODE_GENERATOR_PATH: str = Field(
        "build_with_ai/components/ast_code_generator", description="Path for AST code generator"
    )

    DEFAULT_MODEL_PATH: str = Field("/app/app/deepseek-coder-6.7b-instruct", description="Default path for app")
...
class ModelConfig(BaseModel):
    ...
    DEFAULT_MODEL_PATH: str = Field("/app/app/deepseek-coder-8b-instruct", description="Default model path")
