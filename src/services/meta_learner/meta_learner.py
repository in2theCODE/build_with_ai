...
class MetaLearner(BaseComponent):
        ...
        try:
            ...
            if self.enable_clustering and HAVE_ML_DEPS:
                ...
                if os.path.exists(clusters_path):
                    ...
                    self.logger.info(f"Loaded problem clusters with {len(self.problem_clusters.get('clusters', {}))} clusters")
    ...
    def _perform_clustering(self) -> None:
        ...
        for i, (example, cluster) in enumerate(zip(self.problem_clusters["vectors"], clusters)):
            ...
            self.problem_clusters["clusters"][cluster_id][strategy] = current_score + self.learning_rate * (reward - current_score)
