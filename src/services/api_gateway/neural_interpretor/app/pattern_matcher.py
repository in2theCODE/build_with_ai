...
class PatternMatcher:
    ...
    async def store_pattern(self, pattern_text: str, embedding: List[float], 
    ...
    async def match(self, query_text: str, embedding: List[float], 
                   threshold: float = 0.85, limit: int = 5) -> Optional[Dict[str, Any]]:
        """
