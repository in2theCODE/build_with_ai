...
from src.services.shared.models import Task, ProcessingMode, TaskStatus, TaskPriority
...
from src.services.shared.validation.validator import ValidationResult, Validator
...
metrics_collector = MetricsCollector("neural_interpreter", enabled=True)
...
class NeuralInterpretor:
    ...
    INTENT_KEYWORDS = {
        "information_retrieval": [
            "find", "search", "lookup", "what is", "tell me about", "information on",
            "get data", "retrieve", "look up", "where can I find"
        ],
        "task_execution": [
            "create", "make", "build", "generate", "execute", "perform", "run",
            "implement", "do", "complete", "finish", "accomplish"
        ],
        "creative_generation": [
            "write", "compose", "design", "draft", "create", "imagine", "story",
            "creative", "novel", "innovative", "artistic", "poem", "song"
        ],
        "analysis": [
            "analyze", "evaluate", "assess", "examine", "study", "investigate",
            "research", "review", "compare", "contrast", "synthesize", "breakdown"
        ],
        "conversation": [
            "chat", "talk", "discuss", "conversation", "hello", "hi", "hey",
            "good morning", "good afternoon", "how are you", "what's up"
        ]
    }

    DOMAIN_KEYWORDS = {
        "technical": [
            "code", "programming", "software", "development", "algorithm", "technical",
            "engineering", "system", "framework", "api", "database", "infrastructure"
        ],
        "business": [
            "business", "finance", "marketing", "strategy", "management", "sales",
            "customer", "market", "revenue", "profit", "commercial", "enterprise"
        ],
        "creative": [
            "creative", "art", "design", "music", "writing", "story", "visual",
            "artistic", "aesthetic", "composition", "style", "narrative"
        ],
        "scientific": [
            "science", "scientific", "research", "experiment", "theory", "hypothesis",
            "analysis", "laboratory", "investigation", "study", "observation", "data"
        ],
        "general": [
            "general", "everyday", "common", "regular", "standard", "normal",
            "typical", "usual", "ordinary", "conventional", "customary"
        ]
    }
    ...
    WORKFLOW_KEYWORDS = {
        "code_generation": [
            "generate code", "write code", "implement function", "create class",
            "coding task", "programming task", "code implementation"
        ],
        "data_analysis": [
            "analyze data", "data processing", "dataset analysis", "statistical analysis",
            "data mining", "data exploration", "data visualization"
        ],
        "content_creation": [
            "create content", "generate article", "write blog", "content creation",
            "draft document", "produce content", "content generation"
        ],
        "customer_support": [
            "customer inquiry", "support request", "customer question", "help customer",
            "resolve issue", "customer problem", "support ticket"
        ],
        "knowledge_retrieval": [
            "find information", "knowledge lookup", "retrieve data", "get details",
            "find answer", "documentation lookup", "information retrieval"
        ]
    }
    ...
    def _analyze_complexity(self, prompt: str, system_message: Optional[str] = None) -> Dict[str, int]:
        ...
        context_indicators = [
            "context", "background", "history", "previously", "before", "after",
            "remember", "recall", "given", "assuming", "based on", "according to"
        ]
        ...
        specialized_indicators = [
            "specifically", "specialized", "expert", "technical", "advanced",
            "professional", "field", "domain", "discipline", "expertise",
            "jargon", "terminology", "framework", "theory", "concept"
        ]
    ...
    def _analyze_actionability(self, text: str) -> Dict[str, int]:
        ...
        tool_indicators = [
            "use", "tool", "api", "search", "query", "lookup", "find",
            "calculate", "compute", "call", "fetch", "retrieve"
        ]
        ...
        data_indicators = [
            "data", "database", "information", "source", "reference", "website",
            "document", "file", "record", "report", "article", "paper"
        ]
        ...
        computation_indicators = [
            ...
            "algorithm", "function", "process", "analyze", "evaluate", "assess"
        ]
    ...
    def _analyze_urgency(self, text: str) -> Dict[str, int]:
        ...
        time_indicators = [
            "urgent", "quickly", "asap", "immediately", "as soon as possible",
            "by today", "by tomorrow", "deadline", "due", "fast", "rapid", "soon"
        ]
        ...
        importance_indicators = [
            ...
            "significant", "major", "primary", "core", "fundamental", "necessary"
        ]
    ...
    def _analyze_specificity(self, text: str) -> Dict[str, int]:
        ...
        # Clarity indicators
        clarity_indicators = [
            "specific", "clear", "well-defined", "detailed", "precise", "exact",
            "explicit", "definite", "particular", "distinct", "focused"
        ]
        ...
        constraint_indicators = [
            "constraint", "limit", "parameter", "boundary", "scope", "restriction",
            "guideline", "requirement", "must", "should", "only", "ensure", "make sure"
        ]
        ...
        example_indicators = [
            "example", "instance", "case", "illustration", "demonstration", "sample",
    ...
    def _analyze_multimodality(self, text: str) -> Dict[str, int]:
        ...
        code_indicators = [
            ...
            "programming", "develop", "implement", "software", "algorithm",
        ...
        visual_indicators = [
            "image", "picture", "graphic", "chart", "graph", "diagram", "visual",
            "illustration", "draw", "plot", "map", "sketch", "figure", "visualization"
        ]
        ...
        data_indicators = [
            "data", "table", "csv", "excel", "spreadsheet", "database", "json", "xml",
            "structured", "format", "schema", "field", "record", "entry", "row", "column"
        ]
    ...
    def determine_service_route(self, metadata: TaskMetadata,
                                workflow_id: Optional[str] = None,
                                workflow_phase: Optional[str] = None) -> str:
        """
...
class NeuralInterpreter:
    ...
    def determine_processing_mode(self, metadata: TaskMetadata) -> ProcessingMode:
        ...
        if (max_complexity >= collaboration_threshold or
                metadata.actionability.tool_usage >= collaboration_threshold or
                metadata.actionability.external_data >= collaboration_threshold):
            return ProcessingMode.COLLABORATIVE

        # Check if task is complex
        elif (max_complexity >= complexity_threshold or
              metadata.actionability.computation >= complexity_threshold):
    ...
    async def process_query(
        ...
        try:
            ...
            processing_mode = ProcessingMode.COLLABORATIVE if require_collaboration else self.determine_processing_mode(
                metadata)
        ...
        if workflow_id and status == "completed":
            ...
            if next_phase:
                ...
                await self.process_query(
                    prompt=payload.get("next_prompt", f"Process workflow {workflow_id} phase {next_phase}"),
