...
from app.components.constraint_relaxer.constraint_relaxer import (
    ConstraintRelaxer,
)
from app.components.feedback_collector.feedback_collector import (
    FeedbackCollector,
)
from app.components.incremental_synthesis.incremental_synthesis import (
...
from app.components.neural_code_generator.enhanced_neural_code_generator import (
    EnhancedNeuralCodeGenerator,
)

# Import services
from app.components.neural_code_generator.neural_code_generator import (
    NeuralCodeGenerator,
)
...
from app.utils.advanced_logger import configure_logging
from app.utils.advanced_logger import get_logger
...
def register_components():
    ...
    factory.register_component(
        ComponentType.CODE_GENERATOR, "neural_code_generator", NeuralCodeGenerator
    )
    ...
    factory.register_component(
        ComponentType.CONSTRAINT_RELAXER, "constraint_relaxer", ConstraintRelaxer
    )

    factory.register_component(
        ComponentType.FEEDBACK_COLLECTOR, "feedback_collector", FeedbackCollector
    )
